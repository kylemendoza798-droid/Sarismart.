...
3. Ilagay ang quantity — madadagdag ito sa **Kasalukuyang Transaksyon** list sa ibaba.
4. Puwede kang magpatuloy mag-scan ng ibang produkto — lahat ng iyon ay maisasama sa isang
   transaksyon.
5. Kapag tapos ka na, i-tap ang **"I-save ang Transaksyon"** — bibigyan ito ng natatanging
   **Transaction Number** (hal. `TXN-20260911-4821`) at petsa, para madaling ma-track sa
   Dashboard.
6. Tingnan sa tab na **Dashboard** ang current stock, profit ngayong araw, at top-selling
   products — makikita rin ang Transaction Number ng bawat entry sa Recent Activity.
7. Sa tab na **Products**, pwede kang magdagdag/mag-edit ng mga produkto at ng kanilang code.
8. Sa tab na **QR Labels**, pwede kang gumawa ng bagong QR para sa bagong produkto at i-print
   agad.
9. Sa tab na **Stores**, pwede kang gumawa ng maraming tindahan — bawat isa ay may sariling
   natatanging QR code at hiwalay na inventory/sales data. I-scan lang ang QR ng isang
   tindahan (mula sa **Scan** tab din) para lumipat doon.
10. Sa parehong tab na **Stores**, may **Backup / Restore** na section — pwede kang mag-export
    ng data bilang JSON file (para may kopya ka), at i-import ito ulit kung sakaling
    magpalit ka ng phone o browser. Gumagana ang app offline dahil naka-save lahat sa
    local storage ng browser — walang internet na kailangan pagkatapos ma-load minsan.
